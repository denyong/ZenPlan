      ...
      {activeTab === 'current' ? (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          ...
          <div className="lg:col-span-9">
            {aiInsight ? (
              <div className="bg-slate-900 text-white p-10 rounded-[3rem] shadow-2xl relative overflow-hidden animate-in fade-in slide-in-from-right-8 h-full">
              ...
              <div className="bg-white p-10 rounded-[3rem] border border-slate-100 shadow-sm space-y-10 animate-in fade-in h-full">
